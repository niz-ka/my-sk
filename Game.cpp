...
Game::Game() : ownerSocket(0), questions({}), code(0), started(false), currentQuestion(0) {}
Game::Game(int socket, int gameCode) : ownerSocket(socket), questions({}), code(gameCode), started(false), currentQuestion(0) {}
